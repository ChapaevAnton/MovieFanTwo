...
import com.w4ereT1ckRtB1tch.moviefan.view.recycler_adapters.FavoritesCatalogAdapter.ItemFilmHolder

class FavoritesCatalogAdapter(private val onItemClickListener: OnItemClickListener) :
