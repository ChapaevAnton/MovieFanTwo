...
class FavoritesCatalogFilmAdapter(private val onItemClickListener: OnItemFilmClickListener) :
    ...
    inner class ItemFilmHolder(itemFilm: View) : RecyclerView.ViewHolder(itemFilm) {
        ...
        fun onBindItemFilm(film: Film?, onItemClickListener: OnItemFilmClickListener) {
            ...
            film?.let { it ->
                ...
                favorites.setImageResource(if (it.getFavorites()) R.drawable.ic_round_favorite_24 else R.drawable.ic_round_favorite_border_24)
            }
